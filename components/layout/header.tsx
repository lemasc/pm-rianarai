...
export default function HeaderComponent({ className }: HeaderProps): JSX.Element {
  return (
    <header className={'w-full font-light text-sm flex flex-col items-center ' + className}>
      ...
      <span className="p-4 text-center sarabun-font">เข้าเรียนทุกวิชาได้จากทีนี่ที่เดียว</span>
    </header>
  )
}
