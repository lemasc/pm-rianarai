  ...
  return (
    <>
      ...
      >
        ...
        {announce &&
          metadata &&
          getUnreadAnnounce(announce, metadata).length > 0 && (
...
export function getUnreadAnnounce(
  ...
  return Object.values(
    announce.filter((a) => !(metadata && metadata.announceId?.includes(a.id)))
  );
}
            ...
            >
              <div title="PM-RianArai" className="flex flex-row items-center">
                ...
                >
                  <span
                    className={
                      landing && top ? "text-yellow-300" : "text-red-500"
                    }
                  >
                    เรียน
                  </span>
                  <span
                    className={
                      landing && top
                        ? "lg:text-purple-300 text-purple-500"
                        : "text-purple-500"
                    }
                  >
                    อะไร
              ...
              {!landing && metadata && width < 640 ? (
                ...
                <div
                  className={
                    ...
                    (landing
                      ? "flex text-white"
                      : "sm:flex hidden dark:text-gray-100 text-gray-800")
                  }
                >
