      ...
      <div className="px-6 py-4">
        ...
        >
          ...
          <h4 className="font-medium text-xl">
            ยินดีต้อนรับสู่ PM-RianArai โฉมใหม่!
          </h4>
        ...
        >
          ...
          <div className="space-y-4 flex flex-col">
            ...
            <span>
              เมื่อถึงเวลา ระบบจะแสดงคาบเรียนโดยอัตโนมัติ
              ที่ต้องทำก็คือแค่กดปุ่มสีฟ้านั่น ใช่เลย
            </span>
        ...
        >
          <div className="space-y-4 flex flex-col">
            ...
            <span>
              เพียงเชื่อมต่อบัญชีกับ Google Classroom
              คุณก็สามารถตรวจสอบงานทั้งหมดได้อย่างง่ายดาย
            </span>
            <span>
              ในอนาคตจะรองรับการเชื่อมต่อมากกว่า 1 บัญชี
              และการแสดงผลแบบปฏิทินด้วยนะ
            </span>
          </div>
          <div className="max-w-sm py-2 border rounded-lg">
            <Image
              src="/v2/work_square.jpeg"
              width={300}
              height={300}
              priority={true}
            />
        ...
        >
          ...
          <span className="text-center max-w-md">
            ในวันที่ 28-30 มิถุนายนที่จะถึงนี้
            จะมีการลงทะเบียนชุมนุมผ่านระบบออนไลน์ขึ้น ไม่ต้องห่วง
            คุณสามารถเข้าได้จากใน <b>PM-RianArai</b> ได้ทันที
          </span>
          <span className="text-center max-w-md">
            รอติดตามในเร็ว ๆ นี้ มาแน่นอน
          </span>
        ...
        >
          ...
          <span className="text-center max-w-md">
            ขอให้ใช้ชีวิตในแต่ละวันอย่างมีความสุขนะ
            หากมีปัญหาอะไรสามารถติดต่อได้ที่{" "}
            <a
